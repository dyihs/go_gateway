...
type ServiceAddHTTPInput struct {
	...
	NeedStripUri           int    `json:"need_strip_uri" form:"need_strip_uri" comment:"启动strip_uri" example:"" validate:"max=1,min=0"`                // 启动strip_uri
	...
	UpstreamConnectTimeout int    `json:"upstream_connect_timeout" form:"upstream_connect_timeout" comment:"建立连接超时，单位s" example:"" validate:"min=0"`   // 建立连接超时
	UpstreamHeaderTimeout  int    `json:"upstream_header_timeout" form:"upstream_header_timeout" comment:"获取header超时，单位s" example:"" validate:"min=0"` // 获取header超时
